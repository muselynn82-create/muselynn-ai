...
# ============================================================
# BTC VOLUME FINAL DECISION 2022-2026
# ============================================================
# 목적:
#   최근장(2022~2026) 기준으로 Volume=1.0 전략의 Lookback 최종 비교
#
# 고정 조건:
#   BTCUSDT
#   1w
...
#
# 출력 시트:
#   BTC_VOLUME_FINAL_RESULTS
#   BTC_VOLUME_FINAL_TRADES
#   BTC_VOLUME_FINAL_MDD
#   BTC_VOLUME_FINAL_YEARLY
#   BTC_VOLUME_FINAL_RUNLOG
#
# MDD:
...
RESULT_SHEET_NAME = "BTC_VOLUME_FINAL_RESULTS"
TRADES_SHEET_NAME = "BTC_VOLUME_FINAL_TRADES"
MDD_SHEET_NAME = "BTC_VOLUME_FINAL_MDD"
YEARLY_SHEET_NAME = "BTC_VOLUME_FINAL_YEARLY"
RUN_LOG_SHEET_NAME = "BTC_VOLUME_FINAL_RUNLOG"

CACHE_PREFIX = "btc_volume_final_2022_2026"
...
def strategy_label(params):
    ...
    return f"LB_{lb}_VOL_{vol}_RR_{rr}"
...
def main():
    print("BTC Volume Final Decision 2022-2026 started:", now_kst(), flush=True)
    ...
    append_run_log(log_ws, "Volume final decision 2022-2026 started")
    ...
    append_run_log(log_ws, "Volume final decision 2022-2026 finished")
    print("BTC Volume Final Decision 2022-2026 finished:", now_kst(), flush=True)
