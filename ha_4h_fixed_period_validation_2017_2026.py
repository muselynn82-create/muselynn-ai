...
RESULT_SHEET_NAME = "HA_4H_FIXED_2017_RESULTS"
TOP_SHEET_NAME = "HA_4H_FIXED_2017_TOP"
PERIOD_SHEET_NAME = "HA_4H_FIXED_PERIODS"
TRADES_SHEET_NAME = "HA_4H_FIXED_2017_TRADES"
RUN_LOG_SHEET_NAME = "HA_4H_FIXED_2017_RUNLOG"

CACHE_PREFIX = "ha_4h_fixed_2017"
...
PARAM_GRID = {
    # HA + Stoch RSI V2 고정 검증
    #
    # 목적:
    # 1) 2022~2026 최상위 BTC 4H 조합을 2017~2026 전체 구간으로 재검증
    # 2) 같은 고정값을 BTC/ETH/SOL에 적용해서 보조전략 후보인지 확인
    # 3) 최적화가 아니라 검증이므로 변수 탐색 금지
    #
    # 고정 조건:
    #   interval = 4h
    #   direction = LONG_ONLY
...
def main():
    print("HA 4H Fixed 2017-2026 Validation started:", now_kst(), flush=True)
    ...
    save_results_df = results_df.head(100)
    ...
    print("HA 4H Fixed 2017-2026 Validation finished:", now_kst(), flush=True)
