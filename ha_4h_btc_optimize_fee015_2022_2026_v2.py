...
RESULT_SHEET_NAME = "HA_4H_BTC_OPT_2022_RESULTS"
TOP_SHEET_NAME = "HA_4H_BTC_OPT_2022_TOP50"
PERIOD_SHEET_NAME = "HA_4H_BTC_OPT_2022_PERIODS"
TRADES_SHEET_NAME = "HA_4H_BTC_OPT_2022_TRADES"
RUN_LOG_SHEET_NAME = "HA_4H_BTC_OPT_2022_RUNLOG"

CACHE_PREFIX = "ha_4h_btc_opt_2022"
...
PARAM_GRID = {
    # HA + Stoch RSI V2
    # BTCUSDT 4H 전용 / 2022~2026 최근장 최적화
    #
    # 고정:
    #   symbol = BTCUSDT
    #   interval = 4h
...
def backtest_params(df, params, collect_trades=True):
    trades = []
    equity = 100.0
    peak_equity = 100.0
    max_drawdown = 0.0
...
def main():
    print("HA 4H BTC Optimize 2022 Fee 0.15 started:", now_kst(), flush=True)
    ...
    print("HA 4H BTC Optimize 2022 Fee 0.15 finished:", now_kst(), flush=True)
