...
# ============================================================
# BTC BIG CANDLE TRAIN VOLUME FILTER 2017-2022
# ------------------------------------------------------------
# 목적:
# - 2022~2026 검증에서 좋았던 volume_ratio 1.0 조건을
# - 2017~2022 학습 구간에서도 재검증
# - BTCUSDT / 1w / BODY 중심
# - 조합 수 작게 유지
# ============================================================
...
RESULT_SHEET_NAME = "BTC_BIG_CANDLE_TRAIN_VOL_RESULTS"
TOP_SHEET_NAME = "BTC_BIG_CANDLE_TRAIN_VOL_TOP20"
TRADES_SHEET_NAME = "BTC_BIG_CANDLE_TRAIN_VOL_TRADES"
RUN_LOG_SHEET_NAME = "BTC_BIG_CANDLE_TRAIN_VOL_RUNLOG"

CACHE_PREFIX = "btc_big_candle_train_vol_2017_2022"
...
def main():
    print("BTC Big Candle TRAIN VOL 2017-2022 started:", now_kst(), flush=True)
    ...
    append_run_log(log_ws, "Train volume filter started")
    ...
    append_run_log(log_ws, "Train volume filter finished")

    print("BTC Big Candle TRAIN VOL 2017-2022 finished:", now_kst(), flush=True)
