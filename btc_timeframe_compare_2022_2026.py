...
# ============================================================
# BTC TIMEFRAME COMPARE 2022-2026
# ============================================================
# 목적:
#   최근장(2022~2026) 기준으로 고정 전략의 타임프레임 최종 비교
#
# 고정 조건:
#   BTCUSDT
#   1w
...
#
# 출력 시트:
#   BTC_TIMEFRAME_COMPARE_RESULTS
#   BTC_TIMEFRAME_COMPARE_TRADES
#   BTC_TIMEFRAME_COMPARE_MDD
#   BTC_TIMEFRAME_COMPARE_YEARLY
#   BTC_TIMEFRAME_COMPARE_RUNLOG
#
# MDD:
...
RESULT_SHEET_NAME = "BTC_TIMEFRAME_COMPARE_RESULTS"
TRADES_SHEET_NAME = "BTC_TIMEFRAME_COMPARE_TRADES"
MDD_SHEET_NAME = "BTC_TIMEFRAME_COMPARE_MDD"
YEARLY_SHEET_NAME = "BTC_TIMEFRAME_COMPARE_YEARLY"
RUN_LOG_SHEET_NAME = "BTC_TIMEFRAME_COMPARE_RUNLOG"

CACHE_PREFIX = "btc_timeframe_compare_2022_2026"
...
def strategy_label(params):
    ...
    return f"{interval}_LB_{lb}_VOL_{vol}_RR_{rr}"
...
def main():
    print("BTC Timeframe Compare 2022-2026 started:", now_kst(), flush=True)
    ...
    append_run_log(log_ws, "Timeframe compare 2022-2026 started")
    ...
    append_run_log(log_ws, "Timeframe compare 2022-2026 finished")
    print("BTC Timeframe Compare 2022-2026 finished:", now_kst(), flush=True)
