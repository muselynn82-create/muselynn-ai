...
RESULT_SHEET_NAME = "BTC_RR_FINAL_2022_RESULTS"
TRADES_SHEET_NAME = "BTC_RR_FINAL_2022_TRADES"
MDD_SHEET_NAME = "BTC_RR_FINAL_2022_MDD"
YEARLY_SHEET_NAME = "BTC_RR_FINAL_2022_YEARLY"
RUN_LOG_SHEET_NAME = "BTC_RR_FINAL_2022_RUNLOG"
...
def main():
    print("BTC RR Final Compare 2022-2026 started:", now_kst(), flush=True)
    ...
    append_run_log(log_ws, "RR final compare 2022-2026 started")
    ...
    append_run_log(log_ws, "RR final compare 2022-2026 finished")
    print("BTC RR Final Compare 2022-2026 finished:", now_kst(), flush=True)
