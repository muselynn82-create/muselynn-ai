...
# ============================================================
# MULTI COIN 1D VS 1W FINAL COMPARE 2017-2026
# ============================================================
# 목적:
#   BTC/ETH/SOL 대상 일봉 최고 전략 vs 주봉 최고 전략 최종 비교
#
# 비교 대상 코인:
...
#   단, ETH/SOL은 Binance 상장 이후 데이터부터 자동 적용
#
# 총 조합:
#   3코인 × 2전략 = 6개
#
# 출력 시트:
#   MULTI_COIN_FINAL_RESULTS
#   MULTI_COIN_FINAL_TRADES
#   MULTI_COIN_FINAL_MDD
#   MULTI_COIN_FINAL_YEARLY
#   MULTI_COIN_FINAL_RUNLOG
#
# MDD:
...
RESULT_SHEET_NAME = "MULTI_COIN_FINAL_RESULTS"
TRADES_SHEET_NAME = "MULTI_COIN_FINAL_TRADES"
MDD_SHEET_NAME = "MULTI_COIN_FINAL_MDD"
YEARLY_SHEET_NAME = "MULTI_COIN_FINAL_YEARLY"
RUN_LOG_SHEET_NAME = "MULTI_COIN_FINAL_RUNLOG"

CACHE_PREFIX = "multi_coin_1d_vs_1w_2017_2026"
...
def main():
    print("Multi Coin 1D vs 1W Final Compare 2017-2026 started:", now_kst(), flush=True)
    ...
    append_run_log(log_ws, "Multi coin 1D vs 1W final compare 2017-2026 started")
    ...
    append_run_log(log_ws, "Multi coin 1D vs 1W final compare 2017-2026 finished")
    print("Multi Coin 1D vs 1W Final Compare 2017-2026 finished:", now_kst(), flush=True)
