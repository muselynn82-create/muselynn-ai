...
# ============================================================
# NY OPEN 5M SHORT BTC ONLY V2
# BTC-only retest after multi-coin result concentrated on ETH:
# - BTCUSDT only / SHORT only
...
RESULT_SHEET_NAME = "NY_OPEN_BTC_SHORT_RESULTS"
TOP_SHEET_NAME = "NY_OPEN_BTC_SHORT_TOP20"
TRADES_SHEET_NAME = "NY_OPEN_BTC_SHORT_TRADES"
RUN_LOG_SHEET_NAME = "NY_OPEN_BTC_SHORT_RUNLOG"
...
def cache_name(symbol, interval_label):
    return f"ny_open_btc_short_{symbol}_{interval_label}_2022_2026.pkl"
...
def main():
    print("NY Open 5M BTC Short Optimizer started:", now_kst(), flush=True)
    ...
    results_df = safe_sheet_df(results_df)
    ...
    best_trades = safe_sheet_df(best_trades)
    ...
    print("NY Open 5M BTC Short Optimizer finished:", now_kst(), flush=True)
