...
# ============================================================
# BTC 1D FINAL VALIDATION 2017-2026
# ============================================================
# 목적:
#   최종 후보 BTC 1D Big Candle 전략 2017~2026 전체 검증
#
# 최종 후보 고정 조건:
#   BTCUSDT
#   interval = 1d
...
#   ema200_filter = True
#   breakout_mode = BODY
#   Binance spot BNB fee discount 반영: 왕복 0.15%
#
# 검증 기간:
#   2017-01-01 ~ 2026-05-25
#
# 총 조합:
#   1개
#
# 출력 시트:
#   BTC_1D_FINAL_2017_RESULTS
#   BTC_1D_FINAL_2017_TRADES
#   BTC_1D_FINAL_2017_MDD
#   BTC_1D_FINAL_2017_YEARLY
#   BTC_1D_FINAL_2017_RUNLOG
#
# MDD:
...
RESULT_SHEET_NAME = "BTC_1D_FINAL_2017_RESULTS"
TRADES_SHEET_NAME = "BTC_1D_FINAL_2017_TRADES"
MDD_SHEET_NAME = "BTC_1D_FINAL_2017_MDD"
YEARLY_SHEET_NAME = "BTC_1D_FINAL_2017_YEARLY"
RUN_LOG_SHEET_NAME = "BTC_1D_FINAL_2017_RUNLOG"

CACHE_PREFIX = "btc_1d_final_2017_2026"
...
def strategy_label(params):
    ...
    return f"{interval}_LB_{lb}_RR_{rr}_VOL_{vol}_BODY_{body}_{ema}"
...
def main():
    print("BTC 1D Final Validation 2017-2026 started:", now_kst(), flush=True)
    ...
    append_run_log(log_ws, "1D final validation 2017-2026 started")
    ...
    append_run_log(log_ws, "1D final validation 2017-2026 finished")
    print("BTC 1D Final Validation 2017-2026 finished:", now_kst(), flush=True)
