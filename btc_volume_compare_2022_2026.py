...
# ============================================================
# BTC BIG CANDLE RR FINAL COMPARE 2022-2026
# ============================================================
# BTC 원본 세팅에서 2022년부터 RR 2.5 vs 3.0만 비교
#
# 원본:
...
RESULT_SHEET_NAME = "BTC_VOL_COMPARE_2022_RESULTS"
TRADES_SHEET_NAME = "BTC_VOL_COMPARE_2022_TRADES"
MDD_SHEET_NAME = "BTC_VOL_COMPARE_2022_MDD"
YEARLY_SHEET_NAME = "BTC_VOL_COMPARE_2022_YEARLY"
RUN_LOG_SHEET_NAME = "BTC_VOL_COMPARE_2022_RUNLOG"

CACHE_PREFIX = "btc_rr_final_2022_2026"
...
def main():
    print("BTC Volume Compare 2022-2026 started:", now_kst(), flush=True)
    ...
    append_run_log(log_ws, "Volume compare 2022-2026 started")
    ...
    append_run_log(log_ws, "Volume compare 2022-2026 finished")
    print("BTC Volume Compare 2022-2026 finished:", now_kst(), flush=True)
