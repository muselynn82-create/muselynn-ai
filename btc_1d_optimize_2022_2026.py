...
# ============================================================
# BTC 1D OPTIMIZE 2022-2026
# ============================================================
# 목적:
#   최근장(2022~2026) 기준으로 BTC 1D Big Candle 최적화
#
# 고정 조건:
#   BTCUSDT
#   interval = 1d
...
RESULT_SHEET_NAME = "BTC_1D_OPT_RESULTS"
TRADES_SHEET_NAME = "BTC_1D_OPT_TRADES"
MDD_SHEET_NAME = "BTC_1D_OPT_MDD"
YEARLY_SHEET_NAME = "BTC_1D_OPT_YEARLY"
RUN_LOG_SHEET_NAME = "BTC_1D_OPT_RUNLOG"

CACHE_PREFIX = "btc_1d_opt_2022_2026"
...
def strategy_label(params):
    ...
    return f"{interval}_LB_{lb}_RR_{rr}_VOL_{vol}_BODY_{body}"
...
def main():
    print("BTC 1D Optimize 2022-2026 started:", now_kst(), flush=True)
    ...
    append_run_log(log_ws, "1D optimize 2022-2026 started")
    ...
    append_run_log(log_ws, "1D optimize 2022-2026 finished")
    print("BTC 1D Optimize 2022-2026 finished:", now_kst(), flush=True)
