...
# ============================================================
# BTC 1D BODY EMA OPTIMIZE 2022-2026
# ============================================================
# 목적:
#   최근장(2022~2026) 기준으로 BTC 1D Big Candle BODY/EMA 최종 비교
#
# 고정 조건:
#   BTCUSDT
#   interval = 1d
...
#
# 비교 대상:
#   min_body_ratio = 0.3 / 0.4 / 0.5 / 0.6 / 0.7
...
#
# 출력 시트:
#   BTC_1D_BODY_EMA_RESULTS
#   BTC_1D_BODY_EMA_TRADES
#   BTC_1D_BODY_EMA_MDD
#   BTC_1D_BODY_EMA_YEARLY
#   BTC_1D_BODY_EMA_RUNLOG
#
# MDD:
...
RESULT_SHEET_NAME = "BTC_1D_BODY_EMA_RESULTS"
TRADES_SHEET_NAME = "BTC_1D_BODY_EMA_TRADES"
MDD_SHEET_NAME = "BTC_1D_BODY_EMA_MDD"
YEARLY_SHEET_NAME = "BTC_1D_BODY_EMA_YEARLY"
RUN_LOG_SHEET_NAME = "BTC_1D_BODY_EMA_RUNLOG"

CACHE_PREFIX = "btc_1d_body_ema_2022_2026"
...
def main():
    print("BTC 1D BODY/EMA Optimize 2022-2026 started:", now_kst(), flush=True)
    ...
    append_run_log(log_ws, "1D BODY/EMA optimize 2022-2026 started")
    ...
    append_run_log(log_ws, "1D BODY/EMA optimize 2022-2026 finished")
    print("BTC 1D BODY/EMA Optimize 2022-2026 finished:", now_kst(), flush=True)
