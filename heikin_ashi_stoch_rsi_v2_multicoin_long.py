...
RESULT_SHEET_NAME = "HA_STOCH_V2_RESULTS"
TOP_SHEET_NAME = "HA_STOCH_V2_TOP20"
TRADES_SHEET_NAME = "HA_STOCH_V2_TRADES"
RUN_LOG_SHEET_NAME = "HA_STOCH_V2_RUNLOG"

CACHE_PREFIX = "ha_stoch_v2"
...
PARAM_GRID = {
    # HA + Stoch RSI V2
    # 기존 최고 결과:
    # BTCUSDT / 4h / LONG_ONLY / TP 3.0 / SL -1.5 /
    # stoch_zone NONE / wick_tolerance 0.0 /
    # ema_price_source REAL_CLOSE / min_ema_distance_pct 0.5
    #
    # 이번 목적:
    # 1) BTC 단일 최적화인지 확인
    # 2) 다른 코인에도 통하는지 검증
...
def main():
    print("Heikin Ashi Stoch RSI V2 Multi-Coin Backtest started:", now_kst(), flush=True)
    ...
    print("Heikin Ashi Stoch RSI V2 Multi-Coin Backtest finished:", now_kst(), flush=True)
